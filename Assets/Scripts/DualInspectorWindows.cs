...
public class DualInspectorWindows
{
    /// <summary>
    ...
    {
        // Get a reference to the `InspectorWindow` type object - used to perform our reflection magic
        // For some reason typeof(Editor).Assembly.GetType("InspectorWindow") returned null for me
        // So I just iterated over the types and picked InspectorWindow
        var inspectorType = typeof (Editor).Assembly.GetTypes().FirstOrDefault(t => t.Name == "InspectorWindow");

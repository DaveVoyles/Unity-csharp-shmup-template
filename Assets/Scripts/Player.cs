...
public class Player : MonoBehaviour
{
    ...
    private float        horizontalMovementLimit;	   // stops the player leaving the view
    private float        verticalMovementLimit;
    ...
    void OnTriggerEnter(Collider other) // must have hit an enemy or enemy bullet
    {
        ...
        if (other.CompareTag("EnemyBullet"))
        {
            ...
            other.gameObject.active = false; // deactivate the bullet
        }
